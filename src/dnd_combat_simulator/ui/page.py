"""High-level Streamlit page orchestration."""
...
from dnd_combat_simulator.ui.state import _build_from_state, ensure_session_random_seed
...
from dnd_combat_simulator.ui.validation_rendering import render_field_error
...
def main() -> None:
    ...
    with _render_section_container():
        ...
        for key in (
            ...
            render_field_error(scenario_pre_errors, key)
