...
def run_damage_simulations(
    *,
    ...
    """Run repeated one-attack-per-round damage simulations.
    ...
    Args:
        ...
        rounds: Number of one-attack rounds in each simulation.
    ...
    Raises:
        ValueError: If ``rounds`` or ``simulations`` is less than 1, or if the
            supplied damage dice are rejected by weapon-attack resolution.
    """
    if rounds < 1:
    ...
    total_attacks = rounds * simulations
    ...
    return SimulationResult(
        ...
        average_damage_per_round=total_damage_all_simulations / total_attacks,
